...
export function useAuthRedirect() {
  ...
  const shouldRedirectToUsers = hasHydrated && pathname === ADMIN_ROUTES.LOGIN && isLoggedIn
  const shouldRedirectToLogin = hasHydrated && pathname !== ADMIN_ROUTES.LOGIN && !isLoggedIn
