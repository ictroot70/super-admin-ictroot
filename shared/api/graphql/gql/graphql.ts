...
export type GetUsersQuery = { getUsers: { __typename: 'UsersPaginationModel', users: Array<{ __typename: 'User', id: number, userName: string, email: string, createdAt: string, profile: { __typename: 'Profile', firstName: string | null, lastName: string | null }, userBan: { __typename: 'UserBan', reason: string, createdAt: string } | null }>, pagination: { __typename: 'PaginationModel', page: number, pageSize: number, totalCount: number, pagesCount: number } } };
