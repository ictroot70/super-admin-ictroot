 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation BanUser($userId: Int!, $banReason: String!) {\n  banUser(userId: $userId, banReason: $banReason)\n}"): (typeof documents)["mutation BanUser($userId: Int!, $banReason: String!) {\n  banUser(userId: $userId, banReason: $banReason)\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation RemoveUser($userId: Int!) {\n  removeUser(userId: $userId)\n}"): (typeof documents)["mutation RemoveUser($userId: Int!) {\n  removeUser(userId: $userId)\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation UnbanUser($userId: Int!) {\n  unbanUser(userId: $userId)\n}"): (typeof documents)["mutation UnbanUser($userId: Int!) {\n  unbanUser(userId: $userId)\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetPosts($endCursorPostId: Int, $searchTerm: String, $pageSize: Int, $sortBy: String, $sortDirection: SortDirection) {\n  getPosts(\n    endCursorPostId: $endCursorPostId\n    searchTerm: $searchTerm\n    pageSize: $pageSize\n    sortBy: $sortBy\n    sortDirection: $sortDirection\n  ) {\n    pageSize\n    pagesCount\n    totalCount\n    items {\n      id\n      ownerId\n      description\n      createdAt\n      updatedAt\n      images {\n        id\n        url\n        width\n        height\n      }\n      postOwner {\n        id\n        userName\n        firstName\n        lastName\n        avatars {\n          url\n          width\n          height\n        }\n      }\n      userBan {\n        reason\n        createdAt\n      }\n    }\n  }\n}"): (typeof documents)["query GetPosts($endCursorPostId: Int, $searchTerm: String, $pageSize: Int, $sortBy: String, $sortDirection: SortDirection) {\n  getPosts(\n    endCursorPostId: $endCursorPostId\n    searchTerm: $searchTerm\n    pageSize: $pageSize\n    sortBy: $sortBy\n    sortDirection: $sortDirection\n  ) {\n    pageSize\n    pagesCount\n    totalCount\n    items {\n      id\n      ownerId\n      description\n      createdAt\n      updatedAt\n      images {\n        id\n        url\n        width\n        height\n      }\n      postOwner {\n        id\n        userName\n        firstName\n        lastName\n        avatars {\n          url\n          width\n          height\n        }\n      }\n      userBan {\n        reason\n        createdAt\n      }\n    }\n  }\n}"];
