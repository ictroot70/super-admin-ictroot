    ...
    <div className="flex w-full items-center justify-between gap-[46px]">
      ...
      <div className="w-[234px] flex-shrink-0">
        <Select
          ...
          size="medium"
          classNames={{
            trigger: "h-[36px] flex items-center px-[12px] py-0 rounded-[2px] bg-dark-500 hover:border-light-900 focus:border-transparent focus:outline-2 focus:outline-primary-500 !w-full",
